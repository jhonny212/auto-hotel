...
export const NavBar = () => {
    return <>
        <nav className=" border-gray-200 ">
            <div className="w-auto flex  flex-wrap items-center justify-between mx-auto p-4 bg-gray-100 shadow-2xl">

                <DropDown />
                <img src={logo} className="h-10" style={{ borderRadius: '15px' }} alt="Flowbite Logo" />
                <a href="https://wa.me/50248441018?text=Deseo reservar!">
                    <FontAwesomeIcon size='2x' color='green' icon={faWhatsapp} />
                </a>
